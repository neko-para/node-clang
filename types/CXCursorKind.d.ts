...
export const enum CXCursorKind {
   ...
   object or class. */
    ...
    LastStmt = OpenACCUpdateConstruct,
...
export type CXCursorKindStr = string & { __brand: 'CXCursorKind' }
export declare const __CXCursorKind_StrNum: {
    [key in CXCursorKindStr]?: CXCursorKind
}
export declare const __CXCursorKind_NumStr: {
    [key in int]?: CXCursorKindStr | CXCursorKindStr[]
}
